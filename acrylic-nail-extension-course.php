                    ...
                    <div class="col-lg-6 col-12">
                        <div class="hero-banner-text">
                            ...
                            <div class="rating-badge d-inline-flex align-items-center">
                                <div class="rating-card d-flex justify-content-start align-items-center gap-1">
                                    ...
                                    <div class="customer-review ms-2">
                                        <img
                                            ...
                                            style="width: 14px"
                                        />
                                        <a href="#" class="customer-reviews-link fw-bold">Customer Reviews</a>
                                    </div>
                                </div>
                            </div>
                            <!-- highlight -->
                        ...
                        <p class="title-description d-none d-md-block">
                            This course is specially designed for beginners willing to gain the high demand skills in
                            the beauty industry and start their journey towards becoming professional nail technicians.
                        </p>
        ...
        <div class="container">
            <div class="experience-gellary-container">
                ...
                <div class="experience-gellary-card-container">
                    <div class="experience-gellary-card"></div>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="d-flex flex-column flex-lg-row align-items-center justify-content-center gap-3 gap-md-5">
                    ...
                    <article class="col-lg-6">
                        <div class="article-about-heading d-none d-lg-block">
                            ...
                            <h2 class="text-start fw-bold">Your Path to Becoming a Nail Professional</h2>
                        </div>
                        <ul>
                            <li
                    ...
                    <div class="col-12 col-lg-6 d-flex">
                        <div class="style-card-boards w-100 d-flex flex-column flex-grow-1">
                            <div class="text-end bg-success-morning">
                                <span class="morning-top top-badge">10 AM - 2 PM</span>
                            </div>
                            <div class="d-flex flex-column flex-grow-1">
                                ...
                                <div class="d-flex flex-column flex-grow-1 style-details">
                                    <div class="suggetions-card flex-grow-1">
                                        ...
                                        <div class="session-type">
                                            <p class="fw-bold style-icon-heading">
                                    ...
                                    <div class="d-flex justify-content-center align-items-center pb-4 mt-auto">
                                        <button class="book-btn morning-top text-white fw-bold border-0 text-center">
                                            Book now
                                        </button>
                                    </div>
                                </div>
                    ...
                    <div class="col-12 col-lg-6 d-flex">
                        <div class="style-card-evening w-100 d-flex flex-column flex-grow-1">
                            <div class="text-end bg-primary-light">
                                <span class="evening-top top-badge">2 PM - 5 PM</span>
                            </div>
                            <div class="d-flex flex-column flex-grow-1">
                                ...
                                <div class="d-flex flex-column flex-grow-1 style-details">
                                    ...
                                    <div class="d-flex justify-content-center align-items-center pb-4 mt-auto">
                                        <button class="book-btn evening-top text-white fw-bold border-0 text-center">
                                            Book now
                                        </button>
                                    </div>
                                </div>
                        ...
                        <div class="accordion accordion-flush" id="faqAccordion">
                            <div class="accordion-item overflow-">
                                ...
                                <div id="collapseOne" class="accordion-collapse collapse show">
                                    <div class="accordion-body">
                                        It usually takes about 1-2 hours to complete a full set of acrylic nail
                                        extensions, depending on the skill level of the technician and the complexity of
                                        the design.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item overflow-">
                                <h3 class="accordion-header mb-0">
                                    ...
                                    >
                                        <span class="question-of-faq"> What should i bring to the class? </span>
                                    </button>
                                </h3>
                                <div id="collapseTwo" class="accordion-collapse collapse">
                                    <div class="accordion-body">
                                        You’ll only need to bring your own nail kit, as everything else will be provided
                                        for you during London's no 1 Acrylic Nail Extension Class. This allows you to
                                        practise with your own tools while we supply the rest to ensure a smooth and
